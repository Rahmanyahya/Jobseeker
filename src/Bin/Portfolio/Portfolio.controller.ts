...
import { AddPortfolio, DeletePortfolio, GetAllPortfolio, GetPortfolioById, UpdatePortfolio } from "Types/Portfolio.types";
...
export class PortfolioController {
    ...
    static async updatePortfolio(req: ClientRequest, res: Response, next: NextFunction): Promise<void> {
    ...
    static async getPortfolioById(req: ClientRequest, res: Response, next: NextFunction): Promise<void> {
    ...
    static async getAllPortfolio(req: ClientRequest, res: Response, next: NextFunction): Promise<void> {
    ...
    static async deletPortfolio(req: ClientRequest, res: Response, next: NextFunction): Promise<void> {
